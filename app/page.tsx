...
export default function WaitlistPage() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-between min-h-screen h-screen bg-neutral-900 overflow-hidden pt-24">
      <div className="flex flex-col items-center">
        <SpotlightNew />
        <h1 className="text-3xl sm:text-6xl text-neutral-100 font-bold mb-4 max-w-screen-lg text-center">
          Showcase and grow your affiliate business
        </h1>
        <p className="text-lg text-neutral-400 mb-8 text-center max-w-screen-sm">
          Create a dedicated video page to showcase all your products and
          redirect your users there either via QR code or via a shortlink.
        </p>
        <Form {...form}>
          <form
      ...
      <div className="w-full relative max-w-screen-lg h-1/2 p-3 bg-neutral-100/80 rounded-t-xl">
        <div className="absolute -top-16 -left-20 flex flex-row gap-2 items-center animate-bounce rotate-45">
          <Link
            href="https://veevo.com"
          ...
          >
            ...
            <p><span className="text-neutral-600">veevo.link/</span>
            <span className="text-neutral-600 font-semibold">kotsas</span></p>
          </Link>
